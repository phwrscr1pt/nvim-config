...
> **ขอบเขต: เอกสารนี้เป็นเรื่องของ Windows เท่านั้น**
>
> เหตุผลที่ต้องใช้ Neovide คือ Windows Terminal (AtlasEngine) วางสระ/วรรณยุกต์ไทยเพี้ยน
> — ซึ่งเป็นปัญหาของ Windows โดยเฉพาะ **บน macOS และ Linux ไม่ต้องใช้ Neovide**
> เพราะ terminal ที่นั่นวางรูปอักษรไทยถูกต้องอยู่แล้ว (CoreText / HarfBuzz)
> และจะได้ไม่ต้องเจอข้อเสียของ Neovide เรื่องตารางไม่ตรงคอลัมน์จากฟอนต์ proportional ด้วย
>
> นี่คือเอกสารฉบับเดียวที่อธิบายว่าทำไมบล็อก `if vim.g.neovide then` ใน
> `lua/core/options.lua` ถึงมีอยู่
